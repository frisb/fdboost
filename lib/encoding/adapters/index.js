(function() {
  var AbstractAdapter, Array, Boolean, DateTime, Double, EPOCH_DATE, Integer, Null, Object, String, Undefined, surreal,
  ...
  module.exports = function(encoding) {
    var ArrayAdapter, BooleanAdapter, DateTimeAdapter, DoubleAdapter, IntegerAdapter, NullAdapter, ObjectAdapter, StringAdapter, UndefinedAdapter;
    return {
