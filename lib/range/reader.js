(function() {
  ...
  module.exports = function(FDBoost) {
    var Reader, debug, fdb, iterate, transactionalIterate;
    fdb = FDBoost.fdb;
    ...
    return Reader = (function(_super) {
      ...
      Reader.prototype.getLastKey = function(tr, callback) {
        if (this.end) {
      ...
      Reader.prototype.init = function(tr, callback) {
      ...
      Reader.prototype.getIterator = function(tr, callback) {
      ...
      Reader.prototype.toArray = function(iterator, callback) {
      ...
      Reader.prototype.forEachBatch = function(iterator, callback) {
        var func;
        func = (function(_this) {
      ...
      Reader.prototype.forEach = function(iterator, callback) {
        var func;
        func = (function(_this) {
      ...
      Reader.prototype.execute = function(tr, iteratorType) {
