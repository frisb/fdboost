(function() {
  ...
  module.exports = function() {
    var BoundariesTask, FDBoost, complete, db, distribute, fdb, getBoundaryKeyRange, sendBoundaryKeys, transactionalDistribute;
    FDBoost = this;
    fdb = this.fdb;
    db = fdb.open();
    ...
    return BoundariesTask = (function(_super) {
      ...
      BoundariesTask.prototype.start = function() {
        db = this.options.tr || fdb.open();
        return transactionalDistribute(db, this, complete);
      };
